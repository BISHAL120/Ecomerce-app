  ...
  return (
    <div>
      ...
      <form className=" d-flex flex-column gap-3 " onSubmit={handleSubmit(onSubmit)}>
        <input placeholder="tittle" {...register("tittle", {required: true})} />
        ...
        <input placeholder="Image-1" {...register("img1", {required: true})} />
        <input placeholder="Image-2" {...register("img2", {required: true})} />
        <input placeholder="Image-3" {...register("img3", {required: true})} />

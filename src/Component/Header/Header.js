        ...
        <>
            <section id='header' className='header-secion-1'>
                <div className="header-top-strip d-flex justify-content-center align-items-center  py-2 ">
                    <p className='text-white mb-0 '>Sign up and get 20% off to your first order.</p>
                    ...
                    <div className="Navbar d-none d-lg-flex container-xxl">
                            ...
                            <div className='menu'>
                                <div class="dropdown">
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <li>
                                            <Link className="dropdown-item" to="/tshart">T-shirt & Polo</Link>
                                        </li>
                                        <li>
                                            <Link className="dropdown-item" to="/jeans">Jeans</Link>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <Link className="dropdown-item" to="/manage">Manage Product</Link>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div className='col-6 row justify-content-end '>
                            <div className='search-card'>
                                ...
                                <Link className='position-relative text-black py-1' to="card"><PiShoppingCartSimpleBold />
                        ...
                        <div className="container-xxl">
                            <div className="row align-items-center justify-content-between py-4">
                                <div className="logo d-flex align-items-center col-6 text-start px-2">
                                    <CgMenu onClick={() => setOpen(!open)} className='fs-2 me-2 ' />
                                    <div className="logo">
                                ...
                                <div className="icons col-6 text-end px-2">
                                    ...
                                    <Link className='text-black' to="/card"><PiShoppingCartSimpleBold className='fs-3 me-2' /></Link>
                                    <Link className='text-black' to="/profile"><FaRegUserCircle className='fs-3' /></Link>
                                </div>
                            </div>
                        </div>
                        
                            <div className={`menus d-flex align-content-start flex-column ${open ? 'active' : ''}`}>
                                <Link className=' text-black' to="/">On Sale</Link>
                                <Link className=' text-black' to="/">New Arrivals</Link>
                                <Link className=' text-black' to="/">Brands</Link>
